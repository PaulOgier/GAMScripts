...
| [**GAM Script Checker**](GAM%20Script%20Checker/) — `gamcheck.py` | Paste a gam command or point it at a script, and it tells you whether it only reads, changes, or deletes, before you run it. It never runs anything. For anyone about to run a command from a forum or an AI chat that they have not fully read. In testing: it can miss things. |
